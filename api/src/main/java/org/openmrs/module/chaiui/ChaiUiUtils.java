 ...
 */
@Component
public class ChaiUiUtils {

	private static final DateFormat dateFormatter = new SimpleDateFormat(ChaiUiConstants.DATE_FORMAT);

	private static final DateFormat timeFormatter = new SimpleDateFormat(ChaiUiConstants.TIME_FORMAT);
	...
	public AppDescriptor getCurrentApp(PageRequest request) {
		return (AppDescriptor) request.getRequest().getAttribute(ChaiUiConstants.REQUEST_ATTR_CURRENT_APP);
	}
	...
	public AppDescriptor getCurrentApp(FragmentActionRequest request) {
		return (AppDescriptor) request.getHttpRequest().getAttribute(ChaiUiConstants.REQUEST_ATTR_CURRENT_APP);
	}
