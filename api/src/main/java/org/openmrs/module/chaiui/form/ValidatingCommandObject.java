...
package org.openmrs.module.chaiui.form;
...
public abstract class ValidatingCommandObject implements Validator {
	...
	public void require(Errors errors, String field) {
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, field, ChaiUiConstants.MODULE_ID + ".error.required");
	}
	...
	public void requireAny(Errors errors, String... fields) {
		...
		errors.rejectValue(fields[0], ChaiUiConstants.MODULE_ID + ".error.required");
	}
