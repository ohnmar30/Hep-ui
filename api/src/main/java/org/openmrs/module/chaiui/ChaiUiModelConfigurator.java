 ...
 */
@Component
public class ChaiUiModelConfigurator implements PageModelConfigurator, FragmentModelConfigurator {

	@Autowired
	ChaiUiUtils chaiUiUtils;

	@Override
	public void configureModel(PageContext pageContext) {
		pageContext.getModel().addAttribute("chaiui", chaiUiUtils);
	}

	@Override
	public void configureModel(FragmentContext fragmentContext) {
		fragmentContext.getModel().addAttribute("chaiui", chaiUiUtils);
	}
}