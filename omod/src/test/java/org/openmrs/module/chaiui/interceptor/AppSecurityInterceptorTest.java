...
package org.openmrs.module.chaiui.interceptor;
...
public class AppSecurityInterceptorTest extends BaseModuleWebContextSensitiveTest {
	...
	public void setRequestApp_shouldSetNullsIfPageAppIdIsNull() throws Exception {
		PageContext pageContext = mockPageContext("chaiui", "test");

		interceptor.setRequestApp(pageContext, null);

		Assert.assertThat(pageContext.getRequest().getRequest().getAttribute("chaiui.current-app"), is(nullValue()));
	...
	public void setRequestApp_shouldCheckPrivilegeIfPageAppIsValid() throws Exception {
		...
		Assert.assertThat((AppDescriptor) pageContext.getRequest().getRequest().getAttribute("chaiui.current-app"), is(testApp));
	...
	public void setRequestApp_shouldSetNullsIfActionAppIdIsNull() throws Exception {
		FragmentActionRequest actionRequest = mockFragmentActionRequest("chaiui", "test", "thing");

		interceptor.setRequestApp(actionRequest, null);

		Assert.assertThat(actionRequest.getHttpRequest().getAttribute("chaiui.current-app"), is(nullValue()));
	}
	...
	public void setRequestApp_shouldCheckPrivilegeIfActionAppIsValid() throws Exception {
		...
		Assert.assertThat((AppDescriptor) actionRequest.getHttpRequest().getAttribute("chaiui.current-app"), is(testApp));
	}
